...
try:
    ...
    df = df.replace(
        ...
        value='SUBSTITUIDO - DE VHD 1130 B G8 PARA VHD 1230 B G9'
        ) # DESCRIÇÃO 

    df = df.replace(to_replace='4565355' , value='4560107')   # CODIGO
    df = df.replace(
    ...
    df = df.replace(to_replace='4850003' , value='4300409')   # CODIGO
    df = df.replace(
        to_replace='INTERRUPTOR INTELIGENTE WIFI EWS 301',
        value='SUBSTITUIDO - DE EWS 301 PARA ETW 3001'
        ) # DESCRIÇÃO  

    df = df.replace(to_replace='4760079' , value='4760126')   # CODIGO
    df = df.replace(
    ...
    df = df.replace(to_replace='4320044' , value='4321712')   # CODIGO
    df = df.replace(
        to_replace='CENTRAL PABX IMPACTA 140 RACK - HIBRIDA, CAP 80 RAMAIS TDM/120 IP, 60 TRONCOS DIG/ 24 ANAL/ 8 GSM/3G, MONT RACK/PAREDE',
        value='SUBSTITUIDO - DE IMPACTA 140 RACK PARA UNITTI 1000'
        ) # DESCRIÇÃO 

    df = df.replace(to_replace='4540014' , value='4000234')   # CODIGO
    df = df.replace(
        to_replace='MODULO CTAL INTRUSAO XEG 4010 3G',
        value='SUBSTITUIDO - DE MODULO 3G PARA MODULO 4G'
        ) # DESCRIÇÃO 

    df = df.replace(to_replace='4570032' , value='4900503')   # CODIGO
    df = df.replace(
        to_replace='CAMERA VIP 5440 B IA - IR 40M, LENTE 3,6mm, RESOL 4MP,IP67, CASE METAL, INTELIG PERIMETRAL, MICROF, ENT CARTAO',
        value='SUBSTITUIDO - DE VIP 5440 IA PARA MODULO VIP 5440 B FC IA'
        ) # DESCRIÇÃO 

    df = df.replace(to_replace='4570027' , value='4900373')   # CODIGO
    df = df.replace(
    ...
    #descricao1 = '***COMPRAR SEPARADO - ACAO DE VENDA ATÉ 20/03/2026***'
    #df['Produto'] = np.where(df['Codigo'].isin(promocao1) , descricao1 , df['Produto'])

    #promocao2 = ['4564069','4570029','4564036','4564037','4570034','4675005','4671085','4671003','4671210','4677008','4540109','4540015','4543582','4540054','4640036','4640047','4640018','4770042','4770059','4770062','4770065','4770074','4770075','4770076','4770080','4710029','4710031','4830213','4830232','4830246','4830224','4830199','4830216','4115100','4320215','4340003','4340013','4340024','4340204','4400072','4400073','4400305','4400348','4400402','4400405','4401042','4990002','4990003','4990144','4990152','4990260','4990690','4991013','4993018','4140020','4140034','4160025','4160026','4160027','4160037','4160044','4160046','4160047','4160048','9940783','9940784','9940897','4710021','4710033','4780193','4780194','4760021','4760030','4760075','4760097','4760101','4760102','4760104','4950167','4950169','4950171','4950172','4950174','4950177','4950179','4950180','4950183','4950184','4950185','4950187','4950188','4950192','4950194','4950195','4950196','4950197','4950199','4950200','4950202','4950204','4950205','4950206','4950208','4950209','4950210','4950211','4950212','4950213','4950215','4950218','4950220','4950223','4950230','4950231','4950232','4950233','4950247','4950275','4950276','4950278','4950349','4950839','4950173','4950274','4950266','4950198','4820142','4820135','4820130','4820131','4820132','4820133','4820134','4820164','4820177','4820180','4820182','4820183','4820195','4820198','4820173','4820179','4820165','4822026','4822032','4822034','4822301','4822046','4822018​','4822020​','4820121','4820030','4820097','4142105','4080085','4830145','4830146','4830149','4830151','4830152']
    #descricao2 = '***COMPRAR SEPARADO - CAMPANHA SELL IN/OUT - 28-02-26***'
    ...
    # Campo de texto para inserir o critério de filtro
        ...
        st.text('Tabela de Referencia : Setembro-2026') # ATUALIZAR SEMPRE A TABELA DA INTELBRAS *****************************
